    ...
    <Container>
           <div className=' bg-offwhite p-[50px] rounded-lg shadow-2xl mt-10'>
             ...
             <div>
                 ...
                 <Heading className="leading-[48px] w-[750px]" text="More than 5,000 users around the world are already using STDEV actively"/>
             </div>
             <div className='flex flex-col items-center justify-center gap-y-2 w-[186px] h-[178px] bg-[#CFDDDB] rounded-md'>
