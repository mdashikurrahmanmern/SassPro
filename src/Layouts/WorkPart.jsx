...
const WorkPart = () => {
  return (
   <section className='bg-[#F3F3F3] pt-[60px] md:pt-[113px] pb-[80px] md:pb-[177px]'>
        <Container>
                <Heading className='pr-[830px] md:pr-0 text-center pb-14' text="The Product we work with."/>
                <Flex className='flex-col md:flex-row ml-3 md:ml-0 justify-between flex-wrap gap-5'>
